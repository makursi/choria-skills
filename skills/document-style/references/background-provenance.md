...
本文件的唯一用途：解释主规范（core-rules.md）为何这样定、外部指南与仓库规则的冲突如何裁决、哪些外部来源已失效。**不进入检查逻辑。** 需要"为什么"时才读本文件。

## 冲突裁决原则

外部指南之间存在差异，与仓库规则冲突时**一律以仓库规则为准**（core-rules.md 已固化），例外只通过例外清单（见 SKILL.md）表达。已知冲突点：
